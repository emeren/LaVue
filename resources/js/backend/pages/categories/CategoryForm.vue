            ...
            <div class="card-header">
                <div>
                    <h3
                        class="card-title"
                        v-text="
                            catData.name ? 'Update category' : 'Add category'
                        "
                    ></h3>
                </div>
                <!-- Small switch -->
...
export default {
    ...
    methods: {
        formSubmit() {
            this.catData.id != null
                ? this.updateCategory()
                : this.createCategory();
        },
        updateCategory() {
            this.$store
                .dispatch("categories/updateCategory", this.catData)
                .then(
                    this.$notify({
                        group: "foo-css",
                        title: "Aktualizacja",
        ...
        createCategory() {
            this.$store
                .dispatch("categories/createCategory", this.catData)
                .then(
                    this.$notify({
                        group: "foo-css",
                        title: "Sukces!",
